...
import { activeSpalten, paginate, resolveLineaturRender, type LineaturRender } from '@/core/knickblatt';
...
export function KnickblattDocument({
  ...
  const render = lineaturRender ?? resolveLineaturRender(config.lineatur);
